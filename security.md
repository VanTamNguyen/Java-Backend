...
The Authorization Server will ask the user to log in (authentication) and after that Authorization Server will ask user consent. If user allows the Authorization Server will redirect user to the client site (client app) by the link below:
    ```
